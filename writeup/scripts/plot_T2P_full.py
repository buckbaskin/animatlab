...
ax1.plot(time[5000:], neg_tor[5000:], linewidth=linewidth, label='- Torque (In)')
ax1.plot(time[5000:], pos_tor[5000:], linewidth=linewidth, label='+ Torque (In)')
ax2.plot(time[5000:], theta[5000:], linewidth=linewidth, label='Position (In)')
ax1.set_ylabel('Neuron Torque (mV)')
ax2.set_ylabel('Position (mV)')
