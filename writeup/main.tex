...
% \hspace{-\parindent}(signed)
Comittee Chair

Roger D. Quinn\\~\\

% \hspace{0.35in} (chair of committee)

% TODO(buckbaskin): Add in committee member names
% \hspace{0.35in}
Comittee Member
...
% TODO(buckbaskin): consider Nick's high level points from the email
