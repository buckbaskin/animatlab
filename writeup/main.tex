...
\listoffigures
% TODO(buckbaskin): verify that all captions are leading caps, otherwise, cap where appropriate
...
% TODO(buckbaskin): reduce the use of it, they, this
% TODO(buckbaskin): move typically forward when it sounds right
% TODO(buckbaskin): doesn't -> does not
% TODO(buckbaskin): wouldn't -> would not
% TODO(buckbaskin): are often -> often are
...
\input{chapters/controller_design}

\chapter{Neuron Design}
\label{chap:neuron_design}
\input{chapters/neuron_design}
...
% \input{chapters/app_neuron_tests}
