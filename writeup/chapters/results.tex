...
\begin{figure}
\centering
\includegraphics[height=2.25in]{results/New_T2A}
...
\begin{figure}
\centering
\includegraphics[height=2.25in]{results/New_T2A_2} % TODO(buckbaskin): complete this thought with a picture and data
...
\begin{figure}
\centering
\includegraphics[height=2.25in]{results/New_P2T} % TODO(buckbaskin): complete this thought with a picture and data
...
\begin{figure}
\centering
\includegraphics[height=2.25in]{results/New_TO}
...
\begin{figure}
\centering
\includegraphics[height=2.25in]{results/New_TO_2}
...
\begin{figure}
\centering
\includegraphics[height=2.25in]{results/New_T2P}
