...
see \myref{fig:StateEstimationHighMass}). Based on these tests, the assumption 
...
not intuitive. See \myref{fig:StateUpdateSimple} and \github{stability/simple\_mass\_model.py}.
...
The torque optimization network, in many cases, converges to the
...
doesn't convert well to a relatively small network of neurons. A future controller iteration may elect to move the
