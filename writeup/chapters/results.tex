...
\begin{figure}
\centering
\includegraphics[height=1.9in]{results/TestVelPosWide}
...
\begin{figure}
\centering
\includegraphics[height=1.9in]{results/TestVelNegWide}
...
\begin{figure}
\centering
\includegraphics[height=1.9in]{results/TestAccelPosWide}
...
\begin{figure}
\centering
\includegraphics[height=1.9in]{results/TestAccelNegWide}
...
\begin{figure}
\centering
\includegraphics[height=1.9in]{results/TestTorqueOptimizationPosWide}
...
\begin{figure}
\centering
\includegraphics[height=1.9in]{results/TestTorqueOptimizationNegWide}
...
\begin{figure}
\centering
\includegraphics[height=1.9in]{results/TestT2APosWide}
...
\begin{figure}
\centering
\includegraphics[height=1.9in]{results/TestT2ANegWide}
...
\begin{figure}
\centering
\includegraphics[height=1.9in]{results/TestT2PExtWide}
...
\begin{figure}
\centering
\includegraphics[height=1.9in]{results/TestT2PFlxWide}
...
\begin{figure}
\centering
\includegraphics[height=1.9in]{results/TestSystemCPosWide}
...
\begin{figure}
\centering
\includegraphics[height=1.9in]{results/TestSystemCNegWide}
...
\begin{figure}
\centering
\includegraphics[height=1.9in]{results/TestSystemNPosWide}
...
\begin{figure}
\centering
\includegraphics[height=1.9in]{results/TestSystemNNegWide}
...
acceleration. The synthetic nervous system controller was tested against sin waves of known
...
(not seen in \myref{fig:TestTorqueOptimizationPos} due to clipping) where the
