...
\begin{figure}[h!]
\centering
\includegraphics[width=5in]{controller_design/FigStrainPressure}
\caption{Strain/pressure relations for different applied loads}
\label{fig:StrainPressure}
\end{figure}
% TODO(buckbaskin): regenerate figure of correct size and with axis labels
...
activating motor neurons. This can come in the form of single-level, single-plus-level or two-level CPG models. \cite{MultiLevelCPG}
