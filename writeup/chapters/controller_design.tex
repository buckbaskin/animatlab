...
Using the reduced system model, the estimated acceleration between now and the next controller 
...
This formulation does leave a singular point in the solution. When the joint is stopped and the joint is centered, then there are no damping or loads that apply torque to the joint. In the region of the singular case, there is a check to pause updating of the internal estimate of joint parameters.
